...
class QuizBot:
    ...
    def __init__(self, json_data: dict, table_name: str, schema_name: str):
        ...
        self.done_message, self.greeting, self.quiz, self.farewell = self.process_quiz(json_data)
    ...
    def process_quiz(self, json_data):
        ...
        done_message = json_data.pop(JSONKeys.done_message.value, None)
        greeting = json_data.pop(JSONKeys.greeting.value, None)
        farewell = json_data.pop(JSONKeys.farewell.value, None)
        ...
        return done_message, greeting, quiz, farewell
